// Cross-Agent Memory Isolation benchmark
// Tests: do agents retrieve only their own memories?

import { Memorai, MemoryAdapter } from "../../src/index.js";
import { OllamaEmbeddingService } from "../../src/embeddings/ollama.js";
import { generateAgentMemories } from "../lib/data.js";
...
export async function runCrossAgentBenchmark(): Promise<BenchmarkResult> {
  ...
  // Write all memories with agent profiles
  ...
  for (const agent of AGENTS) {
    ...
    // Count how many retrieved memories belong to this agent
